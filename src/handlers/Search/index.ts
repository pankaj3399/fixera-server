...
async function searchProjects(
  ...
  try {
    ...
    console.log('??? Calculating first available dates for', filteredProjects.length, 'projects');
    ...
    if (startDateFrom || startDateTo) {
      console.log('??? Applying start date range filter:', { startDateFrom, startDateTo });
