      ...
      levels: [
        {
          ...
          perks: {
            ...
            searchRankingBoost: 1
          },
          pointsBoostRatio: 100,
          isActive: true,
          color: '#6B7280',
          icon: 'user'
        },
        {
          ...
          criteria: {
            ...
            minDaysActive: 60,
            minAvgRating: 4.0,
            minOnTimePercentage: 80,
            minResponseRate: 80
          },
          perks: {
            badge: 'rising-badge',
            commissionReduction: 1,
            searchRankingBoost: 1.1
          },
          pointsBoostRatio: 100,
          isActive: true,
          color: '#10B981',
        ...
        },
        {
          ...
          order: 3,
          criteria: {
            minCompletedBookings: 15,
            minDaysActive: 120,
            minAvgRating: 4.3,
            minOnTimePercentage: 85,
            minResponseRate: 90
          },
          perks: {
            badge: 'level-1-badge',
            commissionReduction: 2,
            searchRankingBoost: 1.2
          },
          pointsBoostRatio: 100,
          isActive: true,
          color: '#3B82F6',
        ...
        },
        {
          ...
          order: 4,
          criteria: {
            minCompletedBookings: 40,
            minDaysActive: 250,
            minAvgRating: 4.5,
            minOnTimePercentage: 90,
            minResponseRate: 95
          },
          perks: {
            badge: 'top-professional',
            commissionReduction: 3,
            searchRankingBoost: 1.4
          },
          pointsBoostRatio: 100,
          isActive: true,
          color: '#8B5CF6',
